...
var baseUrl="https://livedemo.espressologic.com/rest/demo/Demo_r9n5u/v1/";

// The API key use to access the demo project
var currentApiKey = "xjwIBkGIiIYkBTU";
...
function setupTooltip() {
	...
	$("[title]").qtip("api").onHide = function(){
		...
		console.log("Destroying all qtips");
		$(".ttTop").qtip("destroy");
		$(".ttBottom").qtip("destroy");
